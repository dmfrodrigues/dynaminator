...
EventDump::EventDump(Time t_, SUMO::NetState &netState_, const Dynamic::SUMOAdapter &adapter_, bool closeAfterDump_):
    Event(t_), netState(netState_), adapter(adapter_), closeAfterDump(closeAfterDump_) {}
