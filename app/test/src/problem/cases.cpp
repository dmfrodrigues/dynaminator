...
pair<StaticNetwork*, StaticDemand*> getStaticProblemTestCase1(){
    StaticNetwork *network = getStaticNetworkTestCase1();

    StaticDemand *demand = new StaticDemand();
...
pair<StaticNetwork*, StaticDemand*> getStaticProblemTestCase2(){
...
pair<StaticNetwork*, StaticDemand*> getStaticProblemTestCase3(){
