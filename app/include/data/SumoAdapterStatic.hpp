...
class SumoAdapterStatic {
    ...
    std::unordered_map<StaticNetwork::Node, SUMO::TAZ::ID> node2sumoTAZ;
    std::unordered_map<SUMO::TAZ::ID, std::pair<StaticNetwork::Node, StaticNetwork::Node>> sumoTAZ2node;
   ...
   public:
    ...
    std::pair<StaticNetwork::Node, StaticNetwork::Node> addSumoTAZ(const SUMO::TAZ::ID &a);
    ...
    const std::pair<StaticNetwork::Node, StaticNetwork::Node> &toTAZNode(const SUMO::TAZ::ID &a) const;
    const SUMO::TAZ::ID &toSumoTAZ(const StaticNetwork::Node &a) const;
